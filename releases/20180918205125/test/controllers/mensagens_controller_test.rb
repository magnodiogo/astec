...
class MensagensControllerTest < ActionController::TestCase
  ...
  test "should create mensagem" do
    assert_difference('Mensagem.count') do
      post :create, mensagem: { ativo: @mensagem.ativo, fim: @mensagem.fim, inicio: @mensagem.inicio, texto: @mensagem.texto, titulo: @mensagem.titulo }
    end
  ...
  test "should update mensagem" do
    patch :update, id: @mensagem, mensagem: { ativo: @mensagem.ativo, fim: @mensagem.fim, inicio: @mensagem.inicio, texto: @mensagem.texto, titulo: @mensagem.titulo }
    assert_redirected_to mensagem_path(assigns(:mensagem))
  end
