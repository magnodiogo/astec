...
$('#seguro_fianca_valor_aluguel').priceFormat({ prefix: '', centsSeparator: ',', thousandsSeparator: '.', clearOnEmpty: true});
$('#seguro_fianca_valor_condominio').priceFormat({ prefix: '', centsSeparator: ',', thousandsSeparator: '.', clearOnEmpty: true });
$('#seguro_fianca_valor_iptu').priceFormat({ prefix: '', centsSeparator: ',', thousandsSeparator: '.', clearOnEmpty: true });
/* FINAL  SEGURO FIANÇA */
